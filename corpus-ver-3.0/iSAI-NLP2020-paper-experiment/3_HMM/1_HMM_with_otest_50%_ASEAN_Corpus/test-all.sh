...
do
   ...
   cat ./t$i/ctest$i.nopipe.word | /home/zar/1_pos_model_setup/jitar-0.3.3-bin/jitar-0.3.3/bin/jitar-tag ./t$i/train$i.nopipe.word.model > ./t$i/ctest$i.nopipe.word.TAGGED
   ...
   #for open testing
   echo -e "\nstart open testing ..."
   cat ./otest.nopipe.word | /home/zar/1_pos_model_setup/jitar-0.3.3-bin/jitar-0.3.3/bin/jitar-tag ./t$i/train$i.nopipe.word.model > ./t$i/otest$i.nopipe.word.TAGGED
