...
Not only the POS tagged corpus version 3.0 but also POS tagging models (trained with CRF, HMM, RDR and NCRF++) are shared in this repository. Please refer text file notes under each model folder. I do hope releasing this myPOS version 3.0 is one of the key milestones of our Myanmar NLP R&D.  
...
*\[at\] နေရာမှာ @ သင်္ကေတကို အစားထိုးပေးပါ။*  
...
Raw data, removed some punctuation characters for several NLP tasks:  [mypos-ver.3.0.shuf.notag.nopunc.txt](https://raw.githubusercontent.com/ye-kyaw-thu/myPOS/master/corpus-ver-3.0/corpus/mypos-ver.3.0.shuf.notag.nopunc.txt)  
