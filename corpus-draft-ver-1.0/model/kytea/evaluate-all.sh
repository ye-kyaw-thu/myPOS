...
# evaluation with evaluation.py for L2 regularized SVM (KyTea) approach
...
do
   ...
   echo -e "\n### Evaluation for L2 regularized SVM train$i model ###"
   ...
   echo -e "\n   -with open test data"
   python2.7 ./evaluate.py ./otest.nopipe ./t$i/otest$i.nopipe.word.TAGGED
